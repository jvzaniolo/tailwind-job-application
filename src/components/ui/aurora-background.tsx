...
export function AuroraBackground() {
  return (
    <div className="absolute inset-x-0 -z-10 flex min-h-screen shrink-0 flex-col items-center justify-center overflow-hidden bg-zinc-50 text-slate-950 dark:bg-zinc-900">
      <div
        className={cn(
